...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipster_microservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipster_microservice API";

        private String description = "jhipster_microservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipster_microservice";
